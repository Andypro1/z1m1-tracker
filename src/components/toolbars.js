...
const Action = {
	...
	Warp: {
		...
		toAnyRoad: { display: 'Any road', hotkeys: ['wa'], name: 'toAnyRoad', mapText: 'Any road'},
		toAnyRoad1: { display: 'Any road 1', hotkeys: ['wa1'], name: 'toAnyRoad1', mapText: 'Any road 1'},
		toAnyRoad2: { display: 'Any road 2', hotkeys: ['wa2'], name: 'toAnyRoad2', mapText: 'Any road 2'},
		toAnyRoad3: { display: 'Any road 3', hotkeys: ['wa3'], name: 'toAnyRoad3', mapText: 'Any road 3'},
		toAnyRoad4: { display: 'Any road 4', hotkeys: ['wa4'], name: 'toAnyRoad4', mapText: 'Any road 4'}
	},

	Equip: {
		woodenArrows: { display: 'Wooden arrows', hotkeys: ['ea'], name: 'woodenArrows', mapText: 'w.arrows' },
		silverArrows: { display: 'Silver arrows', hotkeys: ['eaa'], name: 'silverArrows', mapText: 's.arrows' },
		bow: { display: 'Bow', hotkeys: ['eb'], name: 'bow', mapText: 'Bow' },
		bait: { display: 'Bait', hotkeys: ['ebb'], name: 'bait', mapText: 'Bait' },
		book: { display: 'Book', hotkeys: ['ebbb'], name: 'book', mapText: 'Book' },
		woodenBoomerang: { display: 'Wooden boomerang', hotkeys: ['ebbbb'], name: 'woodenBoomerang', mapText: 'w.b-rang' },
		magicalBoomerang: { display: 'Magical boomerang', hotkeys: ['ebbbbb'], name: 'magicalBoomerang', mapText: 'm.b-rang' },
		blueCandle: { display: 'Blue candle', hotkeys: ['ec'], name: 'blueCandle', mapText: 'b.candle' },
		redCandle: { display: 'Red candle', hotkeys: ['ecc'], name: 'redCandle', mapText: 'r.candle' },
		...
		magicalKey: { display: 'Magical key', hotkeys: ['ek'], name: 'magicalKey', mapText: 'm.key' },
		ladder: { display: 'Ladder', hotkeys: ['el'], name: 'ladder', mapText: 'Ladder' },
		letter: { display: 'Letter', hotkeys: ['ell'], name: 'letter', mapText: 'Letter' },
		longBeam: { display: 'Long beam', hotkeys: ['ell'], name: 'longBeam', mapText: 'Long beam' },
		...
		powerBracelet: { display: 'Power bracelet', hotkeys: ['ep'], name: 'powerBracelet', mapText: 'p.bracelet' },
		raft: { display: 'Raft', hotkeys: ['er'], name: 'raft', mapText: 'Raft' },
		magicalRod: { display: 'Magical rod', hotkeys: ['err'], name: 'magicalRod', mapText: 'm.rod' },
		recorder: { display: 'Recorder', hotkeys: ['errr'], name: 'recorder', mapText: 'recorder' },
		blueRing: { display: 'Blue ring', hotkeys: ['errrr'], name: 'blueRing', mapText: 'b.ring' },
		redRing: { display: 'Red ring', hotkeys: ['errrrr'], name: 'redRing', mapText: 'r.ring' },
		...
		variaSuit: { display: 'Varia suit', hotkeys: ['ev'], name: 'variaSuit', mapText: 'Varia suit' },
