			...
			<tbody>
				{#each storageSaves as item }
					<tr>
						<td>
							<div class="actions">
								<button on:click={goto(`/solo/${item.key}`)} class="btn">
                                    <div>Resume solo</div>
                                    <i class="smallicon sprite-index36"></i>
                                </button>
								<button on:click={() => loadCoop(item.key)} class="btn">
                                    <div>Resume coop</div>
                                    <i class="smallicon sprite-index37"></i>
					                <i class="smallicon sprite-index38"></i>
                                </button>
								<button class="btn" on:click={() => trash(item.key)} style="padding: 0 1rem;">
